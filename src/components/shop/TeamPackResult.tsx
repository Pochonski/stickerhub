...
function cardTeam(card: PackCard) {
  return TEAMS[card.teamId];
}
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    background: `linear-gradient(180deg, ${t?.color ?? card.teamColor} 0%, ${t?.colorDark ?? card.teamColorDark} 100%), url('/card-bg.png') center/cover`,
                ...
                <div className="text-[11px] font-bold p-2 bg-[var(--color-surface)] text-center leading-tight">
                  {t?.flag && <span className="text-[9px] block leading-none mb-0.5">{t.flag}</span>}
                  {card.name}
                </div>
                <span
