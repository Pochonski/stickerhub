...
-- Add coins column
ALTER TABLE user_packs ADD COLUMN IF NOT EXISTS coins INTEGER DEFAULT 500;

-- New users start with 500 coins (1 free pack)
...
UPDATE user_packs SET coins = 500 WHERE coins IS NULL;
